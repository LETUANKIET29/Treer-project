 ...
 * @author Triệu
 */
public class changePlantDescriptionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String newDesctiption=request.getParameter("newDescription");
            int id=Integer.parseInt(request.getParameter("plantid"));
            if (!newDesctiption.isEmpty()) {
                PlantDAO.changePlantDescriptionByID(id, newDesctiption);
            }
